	...
	\section{Przegląd istniejących rozwiązań}
		...
		\begin{enumerate}[label=\Alph*.]
			...
			\item System z uwierzytelnieniem przez OTP (ang. \textit{One Time Password}, hasło jednorazowe)
				...
				Uwierzytenienie w systemie tego rodzaju wymaga wprowadzenia jednorazowego hasła, które generowane jest przez serwer, a następnie zapisywane w systemie i wysyłane do użytkownika w wiadomości tekstowej. Przy próbie dostępu, użytkownik podaje otrzymane hasło, które zostaje porównane z hasłem zapisanym w systemie. Po dokonaniu porównania jest ono usuwane. Główną zaletą tego rozwiązania jest znacząco zmniejszona podatność na ataki powtórzeniowe, w których atakujący przechwytuje dane wykorzystane do autoryzacji i używa ich ponownie w celu uzyskania dostępu. Problemem jest konieczność dostępności użytkownikownika w sieci GSM w celu przekazania hasła za pomocą wiadomości SMS.
