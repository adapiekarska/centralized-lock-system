    ...
    \section{Wymagania funkcjonalne}
        ...
        \section{Wymagania pozafunkcjonalne}
            ...
            \begin{subtable}[c]{\textwidth}
                \centering
                \begin{tabular}{|p{2cm}|p{12cm}|}
                    \hline XXRQ\_1      & \textbf{Długość czasu pracy na baterii równa minimum 1 rok}  \\
        ...
        \section{Komponenty systemu}
            ...
            \subsection{Podsystemy}
                ...
                W tabeli \ref{tbl:subsystems} przedstawiono podsystemy wraz z lokalizacją oraz przynależnymi im komponentami programowymi.
            ...
            \subsection{Komponenty sprzętowe}
                ...
                W tabeli \ref{tbl:hw_comp} przedstawiono komponenty sprzętowe systemu.
            ...
            \subsection{Komponenty programowe}
                ...
                W tabeli \ref{tbl:sw_comp} przedstawiono komponenty programowe systemu.
        ...
        \section{Projekt architektury}
            ...
            Na rysunku \ref{fig:hl-arch} przedstawiono architekturę systemu z podziałem na komponenty sprzętowe oraz podsystemy.
            ...
            Na rysunku \ref{fig:lock-arch} przedstawiono szczegółową budowę układu zamka.
            ...
            \textbf{TBD - budowa podsystemu autoryzacyjnego}

            Na rysunku \ref{fig:mngmt_subsystem} przedstawiono szczegółową budowę podsystemu zarządzającego. 
        ...
        \section{Sposób działania}
            ...
            \textbf{dodać scenariusz dodawania nowego identyfikatora}
                ...
                % System tworzą następujące komponenty sprzętowe:

                % \begin{enumerate}

                %     \item Komponent sterujący zamkiem, inaczej nazywany układem zamka

                %         Jedynym podsystemem zlokalizowanym w obrębie tego komponentu jest podsystem sterowania zamkiem.

                %         Komponent sterujący zamkiem składa się z następujących subkomponentów:
                ...
                %         W jego obrębie zlokalizowane są podsystemy autoryzacji i zarządzania oraz baza danych.

                % \end{enumerate}

            % \subsection{Podsystemy}

                % Poniżej wylistowano wyodrębnione podsystemy wraz z ich najważniejszymi funkcjami. 
                ...
                %         Podsystem zarządzania składa się z dwóch komponentów programowych: aplikacji GUI oraz aplikacji API. Rysunek \ref{fig:mngmt_subsystem} przedstawia jego budowę.
        ...
        \textbf{TBD - oddzielić jakoś diagramy sprzętowe od funkcjonalnych}
