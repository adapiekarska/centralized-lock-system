    ...
    \section{Oprogramowanie zarządzające}
    	...
    	\begin{itemize}
    		...
    		\item Aplikacja API (backend)
    			...
    			\begin{itemize}
    				\item warstwy definiującej punkty końcowe (ang. \textit{endpoints}) REST API,
    				\item warstwy usług,
    				\item warstwy modelu danych.
    			\end{itemize}

    			Warstwa definiująca punkty końcowe składa się z następujących modułów:

    			\begin{itemize}
    				\item \texttt{AccessResource} - odbiera żądania i wysyła odpowiedzi dotyczące prób dostępu,
    				\item \texttt{LockResource} - odbiera żądania i wysyła odpowiedzi dotyczące zamków,
    				\item \texttt{TokenResource} - odbiera żądania i wysyła odpowiedzi dotyczące identyfikatorów,
    				\item \texttt{AuthMappingResource} - odbiera żądania i wysyła odpowiedzi dotyczące powiązań pomiędzy identyfikatorami i zamkami.
    			\end{itemize}
    			...
    			Warstwa modelu danych składa się z następujących modułów:

    			\begin{itemize}
    				\item \texttt{Access} - modeluje obiekt reprezentujący próbę dostępu,
    				\item \texttt{Lock} - modeluje obiekt reprezentujący zamek,
    				\item \texttt{Token} - modeluje obiekt reprezentujący identyfikator,
    				\item \texttt{AuthMapping} - modeluje obiekt reprezentujący powiązanie pomiędzy identyfikatorem i zamkiem.
    			\end{itemize}
